...
import '../Category.css';
import GroceriesBanner from '../../images/groceriesBanner.jpg';
...
const Category = () => {
  ...
  useEffect(() => {
    // Save liked products to local storage
    localStorage.setItem("likedProducts", JSON.stringify(likedProducts));
  }, [likedProducts]);

  useEffect(() => {
    // Save carted products to local storage
    ...
    <div className="Category__container">
      <div className="Category__wrapper">
        ...
        <div className="Category__banner">
          <img src={GroceriesBanner} alt="CategoryBanner" />
        ...
        <div className="Category__products">
          {products.map((product) => {
            ...
            const isCarted = cartedProducts.some(p => p.id === product.id); // Check if the product is carted
            return (
