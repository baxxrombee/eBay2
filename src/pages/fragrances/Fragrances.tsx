...
import '../Category.css';
import fragrancesBanner from '../../images/fragrancesBanner.jpg';
...
const Category = () => {
  ...
  useEffect(() => {
    // Save liked products to local storage whenever likedProducts changes
    localStorage.setItem("likedProducts", JSON.stringify(likedProducts));
  }, [likedProducts]);

  useEffect(() => {
    // Save carted products to local storage whenever cartedProducts changes
    ...
    <div className="Category__container">
      <div className="Category__wrapper">
        ...
        <div className="Category__banner">
          <img src={fragrancesBanner} alt="CategoryBanner" />
